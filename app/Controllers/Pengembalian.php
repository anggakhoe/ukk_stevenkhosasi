...
class Pengembalian extends BaseController
{
    ...
    public function menu_laporan()
    {
        if (session()->get('level') == 1 || session()->get('level') == 2) {
            ...
            $data['desc'] = 'Anda dapat mengprint Data Pengembalian di Menu ini.';      
            $data['subtitle'] = 'Print Laporan Pengembalian';             
            $data['subtitle2'] = 'Print Laporan Pengembalian Per Hari';             

            echo view('hopeui/partial/header', $data);
            echo view('hopeui/partial/side_menu');
            echo view('hopeui/partial/top_menu');
            echo view('hopeui/laporan_pengembalian/menu_laporan', $data);
    ...
    public function export_windows()
    {
        if (session()->get('level') == 1 || session()->get('level') == 2) {
            ...
            $data['peminjaman'] = $model->getAllPengembalianInRange($awal, $akhir);
    ...
    public function export_excel()
    {
        if (session()->get('level') == 1 || session()->get('level') == 2) {
            ...
            $peminjaman = $model->getAllPengembalianInRange($awal, $akhir);
...
public function export_pdf_per_hari()
{
    ...
    public function export_excel_per_hari()
    {
        if (session()->get('level') == 1 || session()->get('level') == 2) {
            ...
            $peminjaman = $model->getAllPengembalianPerHari($tanggal);
